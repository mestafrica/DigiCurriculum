    ...
    >
      <div className="w-full max-w-md p-8 bg-white rounded-lg shadow-lg">
        <form onSubmit={handleSubmit}>
          <h2 className="text-2xl font-bold mb-6 text-center" style={{ color: '#333333' }}>Developer Login</h2>
          ...
          <p className="mt-4 text-center text-gray-600">
            Don’t have an account? <Link to="/devsignup" className="text-black underline">Sign up</Link>
          </p>
