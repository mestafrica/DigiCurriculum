  ...
  return (
    <>
      <div className="flex flex-wrap justify-center p-8">
        <div className="w-full h-full lg:w-1/3 p-4 backdrop-blur-sm bg-white/10 border border-secondary rounded-lg">
          <div className="text-center">
            <h2 className="text-2xl text-accent font-bold">{userData.name}</h2>
          </div>
          ...
          <div className="text-center mt-4">
            <p className="text-sm text-textColor">{uploadStatus}</p>
          </div>
        </div>
          ...
          <div className="backdrop-blur-sm bg-white/10 border border-secondary shadow-lg rounded-lg p-4">
            ...
            <div className="flex w-full flex-col gap-4 mt-4">
              <div className="flex gap-4 my-4">
                ...
                <button
                  ...
                  className="w-1/3 h-8 bg-secondary hover:bg-primary text-white font-bold rounded"
                >
                  Update Profile
                </button>
              </div>
            ...
            <div className="flex gap-4 my-4">
              ...
              <button
                ...
                className="w-1/3 max-h-8 min-h-4 bg-secondary hover:bg-primary text-white font-bold rounded"
              >
                Update Password
              </button>
            </div>
