...
const Tasks = () => {
  ...
  return (
    <>
      <div className="md:mt-0 mt-10 flex flex-col items-center space-y-4 p-4 bg-blue-100">
        <div className="bg-blue-100 md:flex space-x-4">
          {/* UPCOMING TASKS */}
          <TaskColumn
        ...
        <div className="flex justify-center mt-4">
          <Link to="/create-task">
            <button
              ...
              className="bg-secondary text-secondary-foreground px-4 py-2 rounded mt-4"
            >
              +
            </button>
          </Link>
